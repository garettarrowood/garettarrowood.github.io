...
With this power enabled, I could rewrite my Formatter class to operate only on the class itself. And no more database, and no more inheriting from ActiveRecord::Base. That looks like this:

...
h1. Using Class Attributes to Get Gid of Your Database
...
p. After I got the app running, I realized I only needed one model & view for the program to do everything it needed. There also was no need for a database, as nothing needed to be saved for future use. Thus it became apparent I should get rid of my database. But how could I persist the POST data back to display in the main view?

Enter Class Attributes.

Instead of saving the attributes as in a new instance of the Formatter class, I could class variables that get redefined everytime the POST data was sent threw the form.
